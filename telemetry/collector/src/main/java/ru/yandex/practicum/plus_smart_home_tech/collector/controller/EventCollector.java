package ru.yandex.practicum.plus_smart_home_tech.collector.controller;
...
import ru.yandex.practicum.plus_smart_home_tech.collector.handler.hub.HubEventHandlerFactory;
import ru.yandex.practicum.plus_smart_home_tech.collector.handler.sensor.SensorEventHandlerFactory;
...
public class EventCollector extends CollectorControllerGrpc.CollectorControllerImplBase {
    ...
    public void collectHubEvent(HubEventProto request, StreamObserver<Empty> responseObserver) {
        try {
            ...
            hubEventHandlerFactory.getHandler(request.getPayloadCase()).handle(request);
            responseObserver.onNext(Empty.getDefaultInstance());
            responseObserver.onCompleted();
        } catch (Exception e) {
            responseObserver.onError(new StatusRuntimeException(
